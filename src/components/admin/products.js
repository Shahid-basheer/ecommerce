...
const Products = ({ data }) => {
  const { deleteProduct, error, clearErrors } = useProductStateValue();
            ...
            <tr key={id} className="bg-white">
              ...
              <td className="px-6 py-2">
                <div>
                  ...
                  <a onClick={()=>deleteHandler(product?._id)} className="px-2 py-2 inline-block text-red-600 bg-white shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 cursor-pointer">
