...
export default function Cart(){
    const {cart,addItemToCart,deleteItemFromCart,saveOnCheckout} = useCartStateValue()
            ...
            <div className="flex flex-col md:flex-row gap-4">
                          ...
                          <figure className="flex leading-5">
                            <div>
                              <div className="block w-16 h-16 rounded border border-gray-200 overflow-hidden">
                                <img src={cartItem.image??"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2t6m3Xlz6rWk1AqrRgcu9B0bDOSlChlMHI1kpaJfWqMTnauZe81JrrIr_PJMjOC2tYpA&usqp=CAU"} alt={cartItem.name} />
                              </div>
                            </div>
              ...
              <aside className="md:w-1/4">
                <article className="border border-gray-200 bg-white shadow-sm rounded mb-5 p-3 lg:p-5">
                  ...
                  <a onClick={checkoutHandler} className="px-4 py-3 mb-2 inline-block text-lg w-full text-center font-medium text-white bg-green-600 border border-transparent rounded-md hover:bg-green-700 cursor-pointer">
                    Continue
                  </a>
