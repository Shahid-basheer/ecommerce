            ...
            <aside className="md:w-1/3">
              <article className="text-gray-600" style={{ maxWidth: "350px" }}>
                ...
                {cart?.cartItems?.map((item,key) => (
                  <figure key={key} class="flex items-center mb-4 leading-5">
                    <div>
                      <div class="block relative w-20 h-20 rounded p-1 border border-gray-200">
                        <img
                          width="50"
                          height="50"
                          src={item.image??"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2t6m3Xlz6rWk1AqrRgcu9B0bDOSlChlMHI1kpaJfWqMTnauZe81JrrIr_PJMjOC2tYpA&usqp=CAU"}
                          alt="Title"
                        />
